...
export const EXPERIENCES: Experience[] = [
  ...
  { id: 11, t: 'Sapa Trek', d: 'Hike through terraced rice fields to remote villages.', lat: 22.3364, lng: 103.8438, img: 'https://images.unsplash.com/photo-1616421590483-e18faea44d67?w=800&q=80' },
  { id: 12, t: 'Ha Giang Loop', d: 'Motorbike through Vietnam’s most spectacular mountain passes.', lat: 22.8233, lng: 104.9839, img: 'https://images.unsplash.com/photo-1549488344-1f9b8d2bd1f3?w=800&q=80' },
  { id: 13, t: 'Phong Nha Cave', d: 'Explore the world’s most spectacular cave systems underground.', lat: 17.5910, lng: 106.2831, img: 'https://images.unsplash.com/photo-1557434522-835fc526017b?w=800&q=80' },
  { id: 14, t: 'Ninh Binh Boat', d: 'Float gently past towering limestone karsts in Trang An.', lat: 20.2588, lng: 105.9754, img: 'https://images.unsplash.com/photo-1596706927976-599187ecad26?w=800&q=80' },
  { id: 15, t: 'Mu Cang Chai', d: 'Witness the breathtaking golden rice terraces in harvest season.', lat: 21.8485, lng: 104.0950, img: 'https://images.unsplash.com/photo-1520625345718-d4c3ec813b10?w=800&q=80' }
];
